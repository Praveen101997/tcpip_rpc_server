...
def helpcommand(username):
    ...
    print('\033[1;36;40m============================================================\033[1;36;40m')
    print('\033[1;30;40mOPTIONS\033[1;30;40m')
    print('\033[1;31;40m - pwd\033[1;31;40m')
    print('\033[1;34;40m - ls\033[1;34;40m')
    print('\033[1;31;40m - cp <src-file-path> <dest-file-path>\033[1;31;40m')
    print('\033[1;34;40m - mv <src-file-path> <dest-path>\033[1;34;40m')
    print('\033[1;31;40m - rm <path-of-file>\033[1;31;40m')
    print('\033[1;30;40mHELPER\033[1;30;40m')
    print('\033[1;31;40m - cd <dir-path>\033[1;31;40m')
    print('\033[1;34;40m - deletedir <dir-path>\033[1;34;40m')
    print('\033[1;31;40m - upload <file-path> <cloud-path-to-upload> <filename>\033[1;31;40m')
    print('\033[1;34;40m - fetch <path-on-cloud> <local-path-to-save>\033[1;34;40m')
    print('\033[1;31;40m - exit\033[1;31;40m')
    print('\033[1;36;40m============================================================\033[1;36;40m')
...
class App(object):
    ...
    def main_loop(self):
        while True:
            ...
            command = str(input('\033[1;32;40mPraveenSharma@CustomShell$\033[1;31;40m\033[0;37;40m ')).split(' ')
            ...
            if command[0] == 'cd' and len(command) == 2:
                ...
                for address in addresses:
                    with ServerProxy(address, allow_none=True) as new_proxy:
                        path_valid, path_exists, rel_path_str = new_proxy.path_check(self.user_id, src)

                        if path_valid and path_exists:
                            if not new_proxy.cp_same_folder(self.user_id, src,dst):
                                print('Can not copy')
